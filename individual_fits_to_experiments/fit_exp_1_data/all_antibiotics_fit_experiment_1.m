...
fittedVals= truncated_fit_simultaneouslyBetaLactams(NGVals,antibioticConcVals,'gentamicin',phi_max(1),-15);
...
fittedVals= truncated_fit_simultaneouslyBetaLactams(NGVals,antibioticConcVals,'spectinomycin',phi_max(2),-8);
...
fittedVals= truncated_fit_simultaneously(NGVals,antibioticConcVals,'penicillin',phi_max(4),-3.6);
...
fittedVals= truncated_fit_simultaneously(NGVals,antibioticConcVals,'ceftriaxone',phi_max(5),-1.2);
...
fittedVals= truncated_fit_simultaneouslyCefixime(NGVals,antibioticConcVals,'cefixime',phi_max(6),-1.5);
...
fittedVals= truncated_fit_simultaneously(NGVals,antibioticConcVals,'chloramphenicol',phi_max(7),-0.5);
...
fittedVals= truncated_fit_simultaneously(NGVals,antibioticConcVals,'ciprofloxacin',phi_max(9),-1);
MICest(9)=fittedVals(1);
Hill_k(9)=fittedVals(2);
pi_min(9)=fittedVals(3);

results_exp_1 = [phi_max,pi_min,MICest,Hill_k];