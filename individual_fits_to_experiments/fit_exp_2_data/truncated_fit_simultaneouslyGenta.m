function [fittedVals,errorVals,confInt,SSEconc]= truncated_fit_simultaneouslyGenta(NGVals,antibioticConcVals,~,phi_max,phi_minIntGuess)
...
%finding the values which are=100
if find(Y==100,1)>0
        Y(find(Y==100))=NaN;
