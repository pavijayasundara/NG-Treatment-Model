function [SSEconc,totalSSE]= SSEFoesrsterSpec(NGVals,antibioticConcVals,titleName,phi_max,phi_min,MIC,Hillk)

thours=[0;1;2;3;4;5;6];
phi_maxVal=phi_max;
conc=antibioticConcVals(2:end-4);
...
function output= model(xEstimate,thours,X)
    ...
    intVals=repmat(X(end),7,1);%initial value of the ODE system
