function [fittedVals,errorVals,confInt,SSEconc]= truncated_fit_simultaneously(NGVals,antibioticConcVals,titleName,phi_max,phi_minIntGuess)
...
lb=[0 0 -150];%lower bound of the estimates
